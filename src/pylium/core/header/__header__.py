...
__manifest__: Manifest = Manifest(
    ...
    dependencies=[],
    changelog=[
        Manifest.Changelog(version=Manifest.Version("0.1.0"), date=Manifest.Date(2025,1,1), author=__parent_manifest__.authors.rraudzus, 
                                 notes=["Initial release"]),
        Manifest.Changelog(version=Manifest.Version("0.1.1"), date=Manifest.Date(2025,5,19), author=__parent_manifest__.authors.rraudzus, 
        ...
        Manifest.Changelog(version=Manifest.Version("0.1.3"), date=Manifest.Date(2025,6,11), author=__parent_manifest__.authors.rraudzus,
                                 notes=["Added __parent_manifest__ to the header module manifest to allow for proper manifest resolution",
...
class Header(ABC, metaclass=HeaderMeta):
    ...
    __manifest__: Manifest = Manifest(
        ...
        changelog=[
            ...
            Manifest.Changelog(version=Manifest.Version("0.1.2"), date=Manifest.Date(2025,5,20), author=__parent_manifest__.authors.rraudzus,
                                 notes=["Added license pointing to project license"]),
            Manifest.Changelog(version=Manifest.Version("0.1.3"), date=Manifest.Date(2025,5,21), author=__parent_manifest__.authors.rraudzus, 
                                 notes=["Creating manifest as child of project manifest now"]),
            Manifest.Changelog(version=Manifest.Version("0.1.4"), date=Manifest.Date(2025,5,25), author=__parent_manifest__.authors.rraudzus, 
                                 notes=["Added __class_type__ to the header class"]),
            Manifest.Changelog(version=Manifest.Version("0.1.5"), date=Manifest.Date(2025,6,8), author=__parent_manifest__.authors.rraudzus,
